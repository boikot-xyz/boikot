    ...
    return <FlexRow>
        { items.map( (item, i) =>
            <button
                ...
                onDragEnter={e => e.preventDefault() + console.log(items, dragging, e.target.textContent) + update(reorderItems(items, items.indexOf(dragging), items.indexOf(e.target.textContent))) + setReorderGracePeriod()}
